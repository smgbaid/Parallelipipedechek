...
public class Map extends AppCompatActivity {
    ...
    private static final boolean  NOTIFICATIONS_ENABLED   = false; // Show zone notifications?
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBackView = findViewById(R.id.navigation__back_view);
        mPrevFloorButton = findViewById(R.id.navigation__prev_floor_button);
        mNextFloorButton = findViewById(R.id.navigation__next_floor_button);
        mPrevFloorView = findViewById(R.id.navigation__prev_floor_view);
        mNextFloorView = findViewById(R.id.navigation__next_floor_view);
        mCurrentFloorLabel = findViewById(R.id.navigation__current_floor_label);
        mZoomInView  = findViewById(R.id.navigation__zoom_in_view);
        mZoomOutView = findViewById(R.id.navigation__zoom_out_view);
        mAdjustModeView = findViewById(R.id.navigation__adjust_mode_view);
        mErrorMessageLabel = findViewById(R.id.navigation__error_message_label);
...
//        try
//        {
//            final String extDir = Environment.getExternalStorageDirectory(Environment.DIRECTORY_DOCUMENTS).getAbsolutePath() + "/Navigine.Demo";
