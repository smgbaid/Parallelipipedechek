...
public class QrScanActivity extends AppCompatActivity {
    ...
    Button btnAction;
    String intentData = "";
    String page = "1234567890";
    String page1 = "987654321";
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (intentData.length() > 0) {
                    if (intentData.equals(page))
                        startActivity(new Intent(QrScanActivity.this, QrInfoActivity.class));
                    else {
                ...
                if (barcodes.size() != 0) {
                    ...
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            btnAction.setText("Accept following URL");
